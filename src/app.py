...
activities = {
    ...
    "Soccer Team": {
        "description": "Outdoor team sport focusing on fitness and competition",
    ...
    "Drama Club": {
        "description": "Acting, theater production, and stagecraft",
    ...
    "Math Club": {
        ...
        "schedule": "Fridays, 2:45 PM - 3:45 PM",
        "max_participants": 18,
